 ...
 * @OA\Schema()
 */
class MaterialUpdateForm extends Model
{
    /**
     * @OA\Property()
     * @var string
    ...
    public function __construct(Material $material, $config = [])
    {
        ...
        $this->load($material->toArray());

        $this->theme = $material->theme_uuid;
        $this->language = $material->language_uuid;
        $this->subjects = ArrayHelper::getColumn($material->subjects, 'subject_uuid');
        $this->tags = ArrayHelper::getColumn($material->tags, 'tag_uuid');
    }
    ...
    public function attributeLabels(): array
    {
        return [
            ...
            'body' => 'Тело материала',
            'image' => 'Изображение',
            'image_remove' => 'Удалить изображение',
        ];
    }
