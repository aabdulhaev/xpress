...
namespace common\behaviors\uploadBehavior;

use shop\behaviors\uploadBehavior\exceptions\FileUploadException;
use Yii;
...
class FileUploadBehavior extends \yii\base\Behavior
{
    ...
    public function beforeSave()
    {
        if ($this->file instanceof UploadedFile) {
            ...
            $this->owner->{$this->attribute} = implode('.', array_filter([$this->file->baseName, $this->file->extension]));
        } else {
    ...
    public function afterSave()
    {
        ...
        if (!$this->file->saveAs($path)) {
            throw new \common\behaviors\uploadBehavior\exceptions\FileUploadException($this->file->error, 'File saving error.');
        }
